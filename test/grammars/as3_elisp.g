...
importDefinition
	:	IMPORT identifierStar semi
	        -> ^(IMPORT_DEF IMPORT identifierStar )
	;
...
variableDefinition
	:	modifiers
		...
		semi
		-> ^(VARIABLE_DEF modifiers $decl variableDeclarator+ )
	;
...
REGEX_LITERAL
	: ('/' REGEX_BODY '/') => '/' REGEX_BODY '/' REGEX_POSTFIX?
	;
